            ...
            child: NestedScrollView(
              ...
              body: TabBarView(
                children: [
                  ...
                  _buildEmptyState(context, 'No playlists yet', 'Start creating playlists to see them here'),
                  _buildEmptyState(context, 'No recent activity', 'Your recently played tracks will appear here'),
                  _buildEmptyState(context, 'No favorite genres', 'Mark genres as favorites to see them here'),
                ],
              ),
            ),
          ),
      ...
      builder: (context, uploadProvider, _) {
        ...
        if (tracks.isEmpty) {
          return _buildEmptyState(
            context,
            'No uploaded tracks',
            'Start uploading tracks to see them here',
          );
        }
